...
router.post('/me/truck-intakes', requireRole('client'), clientController.recordTruckIntake);
router.patch('/me/truck-intakes/:id', requireRole('client'), clientController.updateMyTruckIntake);
router.delete('/me/truck-intakes/:id', requireRole('client'), clientController.deleteMyTruckIntake);
