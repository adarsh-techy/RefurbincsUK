...
import RepeatIntakeAlert from '../widgets/RepeatIntakeAlert';
...
function Navbar({ onMenuClick }) {
  ...
  return (
    <header
      className={`sticky top-0 z-30 flex h-16 sm:h-20 items-center justify-between gap-2 sm:gap-3 px-3.5 sm:px-6 transition-colors shadow-xs border-b border-slate-200/80 dark:border-white/10 ${
