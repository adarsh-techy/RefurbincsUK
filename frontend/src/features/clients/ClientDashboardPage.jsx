...
function ClientDashboardPage() {
  ...
  return (
    <div className="space-y-7 pb-12">
      ...
      {/* ── Top Header Section (Clean & Classic) ────────────────────── */}
        ...
        <div className="flex items-start gap-3.5">
          {client?.logo_path && (
            <img
              ...
              className="h-8 w-8 shrink-0 rounded-lg border border-slate-200/80 bg-white object-contain p-1 shadow-2xs dark:border-white/10 dark:bg-surface-850"
            />
          )}
          <div>
          <div className="flex items-center gap-2.5 mb-1">
            ...
            {client?.name && (
              <span className="rounded-xl bg-emerald-100 px-3 py-0.5 text-xs font-extrabold text-emerald-800 border border-emerald-300/80 dark:bg-emerald-950/60 dark:text-emerald-300 dark:border-emerald-800/40">
                {client.name}
              </span>
            )}
          </div>
        ...
        <div className="flex items-center gap-2.5 flex-wrap">
          ...
          <form onSubmit={handleInlineSubmit} className="relative">
            <input
              ...
              placeholder="Search Battery ID or Serial…"
              className="w-56 sm:w-64 rounded-xl border border-slate-200 bg-white py-2 pl-8 pr-3 text-xs font-medium text-slate-800 placeholder:text-slate-400 shadow-2xs focus:border-emerald-500 focus:outline-hidden dark:border-white/10 dark:bg-surface-850 dark:text-white"
            />
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 rounded-xl px-3.5 py-2 text-xs font-bold text-white shadow-xs hover:opacity-90 active:scale-98 transition-all"
          >
      ...
      <div className="rounded-3xl border border-slate-200/80 bg-white p-6 shadow-sm dark:border-white/10 dark:bg-surface-900">
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
          ...
          <Link
            to="/my/batteries/pending"
            className="group relative flex flex-col justify-between rounded-2xl border border-blue-200/70 bg-gradient-to-b from-blue-50/40 to-white p-5 shadow-2xs transition-all hover:border-blue-400 hover:shadow-md dark:border-blue-900/30 dark:from-blue-950/20 dark:to-surface-850"
          >
            <div>
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-2.5">
                  <span className="flex h-9 w-9 items-center justify-center rounded-xl bg-blue-100 text-blue-700 shadow-2xs dark:bg-blue-900/50 dark:text-blue-300">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-5 w-5">
                ...
                <span className="rounded-full bg-blue-100 px-2.5 py-0.5 text-xs font-extrabold text-blue-900 dark:bg-blue-950/70 dark:text-blue-200">
                  {inProgress + inTesting + completed} Units
                </span>
              </div>
              ...
              <p className="mt-1 text-xs text-slate-500 dark:text-neutral-400">
                Currently under cell repair, BMS reconfiguration, or cycle testing.
              </p>
            </div>
          ...
          >
            <div>
              ...
              <p className="mt-1 text-xs text-slate-500 dark:text-neutral-400">
                Successfully dispatched & back in operation with full health reports.
              </p>
            </div>
            <div className="mt-4 flex items-center justify-between border-t border-slate-100 pt-3 text-xs font-bold text-emerald-700 dark:border-white/5 dark:text-emerald-400">
              <span>View Operational Fleet</span>
              <span className="transition-transform group-hover:translate-x-1">→</span>
            </div>
          </Link>
        </div>
            ...
            <div className="flex items-center justify-between border-b border-slate-100 pb-3 dark:border-white/5">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-slate-400">Direct line to operations team</p>
                </div>
              </div>
            ...
            <div className="mt-4 space-y-2.5">
              {recentTickets.length === 0 ? (
                <div className="rounded-2xl border border-dashed border-slate-200 bg-slate-50/50 p-6 text-center dark:border-white/10 dark:bg-surface-850">
                  ...
                  <p className="mt-1 text-[11px] text-slate-400">Need help with a battery or delivery?</p>
                </div>
              ) : (
                recentTickets.map((t) => (
                  <Link
