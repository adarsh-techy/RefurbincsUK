...
export function resolveImageUrl(path) {
  ...
  // staff-docs, issue-photos and return-docs are served behind requireAuth, which accepts
  // the token as a query param since <img src> can't carry an Authorization header.
  const needsAuth =
    cleanPath.startsWith('/uploads/staff-docs') ||
    cleanPath.startsWith('/uploads/issue-photos') ||
    cleanPath.startsWith('/uploads/return-docs');
